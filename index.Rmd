...
What defines success? Popularity among readers? Quality of the series? Both? And could these factors be related?

To measure both popularity and quality, the following metrics of success are compared to genre:
...
Originals are WEBTOON-sponsored stories. Original series are provided a company editor, advertisement priority on the WEBTOON app, and other benefits.
...
The observations regarding the subscribers-rating relationship across all genres still holds for most individual genres. SPORTS and TIPTOON, however, both appear to have a weak correlation between subscribers and ratings.

Note that TIPTOON is a special case: all the series under the genre are created by WEBTOON and are mostly informational.
...
# 3. Conclusion
Through this analysis, we conclude that 

## Table 2
```{r final_originals_table, echo=FALSE}
read_rds(file = "custom_top_originals.rds")
```
##### *(Kaggle, 2022)*
